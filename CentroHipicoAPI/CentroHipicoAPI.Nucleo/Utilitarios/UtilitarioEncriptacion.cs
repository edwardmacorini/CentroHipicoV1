...
namespace CentroHipicoAPI.Nucleo.Utilitarios
{
    public static class UtilitarioEncriptacion
    {
        public static string EncriptarCadena(string clave, string cadena)
        {
        ...
        public static string DesencriptarCadena(string clave, string cadena)
        {
            byte[] llave;
