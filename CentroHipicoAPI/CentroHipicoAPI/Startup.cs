...
namespace CentroHipicoAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IRepositorioEjemplar, RepositorioEjemplar>();
            services.AddTransient<IRepositorioUsuario, RepositorioUsuario>();
            services.AddTransient<IServicioCarrera, ServicioCarrera>();
            services.AddTransient<IServicioCliente, ServicioCliente>();
            services.AddTransient<IServicioEjemplar, ServicioEjemplar>();
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "CentroHipicoAPI", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "CentroHipicoAPI v1"));
            }
